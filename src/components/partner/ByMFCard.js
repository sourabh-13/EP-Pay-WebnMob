  ...
  if (minPageNumberLimit >= 1) {
    ...
    <nav className="navbar navbar-main navbar-expand-lg px-0 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      ...
      <nav aria-label="breadcrumb">
          ...
          <h6 className="font-weight-bolder mb-0">{t('MemberShip Card')}</h6>
        </nav>
                          ...
                          <div id="datatable_wrapper" className="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                              ...
                              <thead>
                                <tr role="row">
                                  ...
                                  <th className="text-center sorting_asc tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-sort="ascending" aria-label="Order: activate to sort column descending"><span className="">{t('Card Number')}</span></th>
                                  <th className="text-center sorting tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-label="ID: activate to sort column ascending"><span className="">{t('Card Description')}</span></th>
                                  <th className="text-center sorting tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-label="ID: activate to sort column ascending"><span className="">{t('Charge')}</span></th>
                                  <th className="text-center sorting tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-label="ID: activate to sort column ascending"><span className="">{t('Use')}</span></th>
                                  <th className="text-center sorting tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-label="ID: activate to sort column ascending"><span className="">{t('Balance')}</span></th>
                                  <th className="text-center sorting tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-label="ID: activate to sort column ascending"><span className="">{t('Charge/Use Date')}</span></th>
                                  <th className="text-center" colspan="9" rowspan="1">{t('Usage History')}</th>
                                  
                                </tr>
                                <tr role="row">
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Print&amp;nbsp;Total: activate to sort column ascending">{t('Payment Date')}</th>
                                  
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Color: activate to sort column ascending">{t('Customer')}</th>
                                  
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Mono: activate to sort column ascending">{t('TID')}</th>
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Copy&amp;nbsp;Total: activate to sort column ascending">{t('Location')}</th>
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Mono: activate to sort column ascending">{t('Amount of payment')}</th>
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Copy&amp;nbsp;Total: activate to sort column ascending">{t('Work type')}</th>
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Mono: activate to sort column ascending">{t('Size')}</th>
                                  ...
                                  <th className="text-center sorting" tabindex="0" aria-controls="list-dt" rowspan="1" colspan="1" aria-label="Copy&amp;nbsp;Total: activate to sort column ascending">{t('Long live')}</th>            
                                </tr>
                              </thead>
                              <tbody>
                              {currentItems.length > 0? currentItems.map((item,i) => {
                                ...
                                }):<tr class="odd"><td valign="top" colspan="15" class="dataTables_empty">{t('No data available')}</td></tr>}
