              ...
              <div className="card p-2 px-4">
                <form action="" className="information_form">
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-md-3">
                      <div className="input-group">                        
                        <select className="classNameic form-select select_options align-left padingtop" onChange={(e)=>{setSelectlocation(e.target.value)}}>
                          ...
                          <div id="datatable_wrapper" className="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                              ...
                              <thead>
                                <tr role="row">
                                  ...
                                  <th className="text-center sorting_asc tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-sort="ascending" aria-label="Order: activate to sort column descending"><span className="">{t('client')}</span></th>
