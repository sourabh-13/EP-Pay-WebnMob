                          ...
                          <div id="datatable_wrapper" className="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                              ...
                              <thead>
                                <tr role="row">
                                  ...
                                  <th className="text-center sorting_asc tabletextalignment" rowspan="2" tabindex="0" aria-controls="list-dt" colspan="1" aria-sort="ascending" aria-label="Order: activate to sort column descending"><span className="">{t('Customer')}</span></th>
                              ...
                              {currentItems.length > 0? currentItems.map((item,i) => {
                                ...
                                }):<tr class="odd"><td valign="top" colspan="20" class="dataTables_empty">{t('No data available')}</td></tr>}
