                      ...
                      <div className="tab-pane active" id="header" role="tabpanel">
                        <div>
                          ...
                          <table className="display table-bordered dataTable no-footer mt-6">
                                    ...
                                    }):<tr class="odd"><td valign="top" colspan="7" class="dataTables_empty">{t('No data available')}</td></tr>}
                                    </tbody>
                                </table>
                                <div>
                            ...
                            <Modal className='modal-box modalPopupCenter' show={isOpen}>
                              <Modal.Header>
                                <h4 className="modal-title">{t('Kiosk Details')}</h4>
                                    ...
                                    <Tab eventKey="home" title={t('Basic')}>
                                      ...
                                      <div className="formProgress manForm pt-2">
                                        ...
                                        <div className="mb-3">
                                          <div className="row">
                                            <div className="col-md-4">
                                              <label className="lablePapding" for="m_topupcomment">{t('Default Language')}</label>
                                            </div>
                                            <div className="col-md-8">
                                        ...
                                        <div className="mb-3">
                                          <div className="row">
                                            <div className="col-md-4">
                                              <label className="lablePapding" for="m_topupcomment">{t('Currency Unit')}</label>
                                            </div>
                                            <div className="col-md-8">
                                        ...
                                        <div className="mb-3">
                                          <div className="row">
                                            <div className="col-md-4">
                                              <label className="lablePapding" for="m_topupcomment">{t('Call Location')}</label>
                                            </div>
                                            <div className="col-md-8">
                                                <form action="">
                                                    <div className="row">
                                        ...
                                        <div className="mb-3">
                                          <div className="row">
                                            <div className="col-md-4">
                                              <label className="lablePapding" for="m_topupcomment">{t('Main screen message')}</label>
                                            </div>
                                            <div className="col-md-8">
