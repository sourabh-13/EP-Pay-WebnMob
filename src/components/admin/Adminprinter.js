                            ...
                            <table className="display table-bordered dataTable no-footer mt-6">
                              <thead>
                                <tr role="row">
                                  ...
                                  <th onClick={() => sorting("printerserial")} className="text-center sorting">{t('Serial No.')}</th>
                                  <th onClick={() => sorting("printermodel")} className="text-center sorting">{t('Model name')} </th>
                                  <th onClick={() => sorting("black")} className="text-center sorting">{t('App version')} </th>
                                  <th onClick={() => sorting("yellow")} className="text-center sorting"><span className="text-dark"><i className="fa fa-tint" aria-hidden="true"></i> {t('black')}</span></th>
                                  <th onClick={() => sorting("cyan")} className="text-center sorting"><span className="text-warning"><i className="fa fa-tint" aria-hidden="true"></i> {t('yellow')}</span></th>
                                  <th onClick={() => sorting("magenta")} className="text-center sorting"><span className="text-info"><i className="fa fa-tint" aria-hidden="true"></i> {t('blue')}</span></th>
                                  <th onClick={() => sorting("lastupdate")} className="text-center sorting"><span className="text-danger"><i className="fa fa-tint" aria-hidden="true"></i> {t('Red')}</span></th>
                                  {/* <th onClick={() => sorting("totalpage")} className="text-center sorting">{t('Recent update')}</th> */}
                                </tr>
                              </thead>
                              <tbody>

                                {currentItems.length > 0 ? currentItems.map(item => {
                                  return <tr onClick={() => openModal({ mseq: item.seq })} className="odd show-modal">
